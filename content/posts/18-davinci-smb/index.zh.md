...
![useradd](./2025-12-21_17-49-40.jpg)

## 必要用户权限的限制与开放

`Win+R`打开运行框，输入`gpedit.msc`打开本地组策略。

![gpedit-1](./2025_12_21_1756.png)

![gpedit-2](./2025-12-21-17-57.png)

![gpedit-3](./2025-12-21-17-58.png)

![gpedit-4](./2025-12-21-17-59.png)

`Win+R`打开运行框，输入`secpol.msc`打开本地安全策略。

![secpol-1](./2025-12-21_18-04-02.jpg)

同样的操作应用于以下选项：

![secpol-2](./2025-12-21-18-05.png)

`Win+I`打开 Windows 设置，按照下图打开必要选项：

![settings](./2025-12-21-18-07.png)
...
![share](./2025-12-21_18-21-22.jpg)

![security](./2025-12-21_18-27-20.png)

## 其他计算机设备的连接

现在在另一台设备上，`Win+E`打开资源管理器，选择**此电脑**，按照下列操作，即可获得一个**Z 盘**，里面是上文的**SMB**文件夹内容。

![pan-1](./2025-12-21-1.jpg)

![pan-2](./2025-12-21-2.png)

![pan-3](./2025-12-21-3.jpg)
...
![Davinci](./2025-12-21_19-23-16.png)
...
在**10.10.10.1**机器上，通过映射网络驱动器操作，获得相同的一个**Z 盘**。

在网络数据库中创建一个新项目，前往项目设置：

![settings](./2025-12-21_19-44-52.png)
