...
根据博文 [如何安全地使用SSH、SFTP？ ](https://blog.srprolin.top/posts/11-ssh-1/)可以创建好一个SSH密钥对，只需要将公钥pub内容，在GitHub的 [SSH and GPG keys](https://github.com/settings/keys) 页面上传`Authentication Key`验证格式即可。
