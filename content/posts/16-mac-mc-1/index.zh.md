...
![mcsmanager-1](./2025-12-07_16-59-33.png)

在 web 页面内使用 Minecraft 模板创建服务器，都是懒人操作，这里不做详细步骤说明了。

![mcsmanager-2](./2025-12-07_17-05-35.png)

现在假设你已经创建了一个实例并进入了 web 后台页面，你需要对服务器启动命令进行设置。

![mcsmanager-3](./2025-12-07_17-10-15.png)
...
![cloudflare](./2025-12-07_18-28-30.png)
