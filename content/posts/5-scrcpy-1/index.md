...
- 运行程序文件，等待手机界面出现，如果不行，可以将手机的 usb 模式选择为 **_管理文件_**
  ![scrcpy](./PixPin_2025-04-19_10-57-41.webp)
