...
image: ../assets/images/placeholder.md
tags:
  - Steam
  - Network
draft: false
...
1. 在设置页面中，找到「CDN 优选」区域
2. 勾选全部（Steam 商店/社区主要 CDN）
3. 如需加速其他平台，可额外勾选对应的 CDN 选项

![](../assets/images/2026-0615-1552.png)

> 📌 **推荐勾选**：Akamai（Steam）、Cloudfront（Huggingface / 部分下载）
