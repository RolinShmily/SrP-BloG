---
title: 使用yt-dlp下载互联网上的任何音视频 | FFmpeg | Python
published: 2026-04-13
pinned: false
description: 基于pip中的yt-dlp工具包打造的快速获取音频(AAC编码m4a)、视频(H.264编码mp4)脚本。
image: ../assets/images/2026-0418-1555.png
tags:
  - Python
  - FFmpeg
draft: false
...
基于 [yt-dlp](https://github.com/yt-dlp/yt-dlp) 封装的 Python 脚本工具集，提供一键下载、自动转码功能。
